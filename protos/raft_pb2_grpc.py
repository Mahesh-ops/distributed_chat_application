...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in protos/raft_pb2_grpc.py depends on'
...
class RaftServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.InstallSnapshot = channel.unary_unary(
                ...
                request_serializer=protos_dot_raft__pb2.InstallSnapshotRequest.SerializeToString,
                response_deserializer=protos_dot_raft__pb2.InstallSnapshotResponse.FromString,
                _registered_method=True)
...
def add_RaftServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'InstallSnapshot': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=protos_dot_raft__pb2.InstallSnapshotRequest.FromString,
                    response_serializer=protos_dot_raft__pb2.InstallSnapshotResponse.SerializeToString,
            ),
    }
...
class RaftService(object):
    ...
    def InstallSnapshot(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/RaftService/InstallSnapshot',
            protos_dot_raft__pb2.InstallSnapshotRequest.SerializeToString,
            protos_dot_raft__pb2.InstallSnapshotResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
